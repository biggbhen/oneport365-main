			...
			<div>
				{sectionList.length > 0 &&
					sectionList.map((item: any, idx: number) => (
						<div key={idx} className='relative overflow-x-auto'>
							<div className='flex gap-x-8 mb-8'>
										...
										<table className='w-full text-sm text-left rtl:text-right text-[#6B7280]'>
											<thead className='text-xs bg-[#F9FAFB]'>
												<tr>
													<th
														scope='col'
														className='p-4 font-normal text-[#6B7280]'>
														Basis
													</th>
													<th
														scope='col'
														className='font-normal text-[#6B7280]'>
														<p className='px-4 border-l border-[#E6E7ECB2] whitespace-nowrap'>
															Unit of measure
														</p>
													</th>
													<th
														scope='col'
														className='font-normal text-[#6B7280]'>
														<p className='px-4 border-l border-[#E6E7ECB2]'>
															Unit
														</p>
													</th>
													<th
														scope='col'
														className='font-normal text-[#6B7280]'>
														<p className='px-4 border-l border-[#E6E7ECB2] flex items-center gap-x-2'>
															Rate
											...
											<tbody>
												{item.section_data.length > 0 &&
													item.section_data.map((item: any, idx: number) => (
														<tr
								...
								<div className='w-[340px] h-fit border rounded-xl border-[#E5E7EB] p-5'>
									...
									<SelectCurrency>Edit section currency</SelectCurrency>
								</div>
							</div>
						</div>
					))}
